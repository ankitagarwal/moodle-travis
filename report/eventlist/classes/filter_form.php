...
class report_eventlist_filter_form extends moodleform {
    ...
    public function definition() {
        ...
        $mform->addElement('header', 'displayinfo', get_string('filtertitle', 'report_eventlist'));
        ...
        $mform->addElement('select', 'eventedulevel', get_string('educationlevel', 'report_eventlist'), $edulevelarray);
