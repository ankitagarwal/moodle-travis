...
$string['crud'] = 'CRUD';
$string['databasequerytype'] = 'Database query type: ';
$string['delete'] = 'delete';
$string['details'] = 'Details';
$string['devdetail'] = 'Developer details';
$string['dname'] = 'Name';
...
$string['pluginname'] = 'Event list report';
$string['read'] = 'read';
$string['relatedobservers'] = 'Related observer information:';
$string['teaching'] = 'Teaching';
$string['typedeclaration'] = '@Type declaration detected!';
