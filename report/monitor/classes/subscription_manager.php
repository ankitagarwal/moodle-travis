...
class subscription_manager {
    ...
    public static function subscribe($ruleid, $courseid, $cmid, $userid = 0) {
        ...
        return $DB->insert_record('report_monitor_subscriptions', $subscription);
    }
    ...
    public static function delete_subscription($subscriptionorid, $checkuser = true) {
        ...
        return $DB->delete_records('report_monitor_subscriptions', array('id' => $subscription->id));
    }
    ...
    public static function get_subscription($subscriptionid) {
        global $DB;
        $sql = self::get_rule_subscription_join_sql();
        $sql .= "WHERE s.id = :id";
     ...
     */
    public static function get_rule_subscription_join_sql() {
