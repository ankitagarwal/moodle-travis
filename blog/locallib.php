...
class blog_entry implements renderable {
    ...
    public function add() {
        ...
        tag_set('post', $this->id, $this->tags, 'core', context_user::instance($this->userid, MUST_EXIST)->id);
    ...
    public function edit($params=array(), $form=null, $summaryoptions=array(), $attachmentoptions=array()) {
        ...
        tag_set('post', $entry->id, $entry->tags, 'core', context_user::instance($this->userid, MUST_EXIST)->id);
    ...
    public function delete() {
        ...
        tag_set('post', $this->id, array(), 'core', context_user::instance($this->userid, MUST_EXIST)->id);
    ...
    public function add_tags_info() {
        ...
        tag_set('post', $this->id, $tags, 'core', context_user::instance($this->userid, MUST_EXIST)->id);
    }
