...
abstract class content_viewed extends base {
    ...
    /**
     * Set content detail.
     * Set a identifier that describes the content that is viewed.
     */
    public function set_content_detail($content) {
    ...
    protected function validate_data() {
        if (debugging('', DEBUG_DEVELOPER)) {
            // Make sure this class is never used directly in module or block context ever.
